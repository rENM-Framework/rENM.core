...
Within the modular rENM ecosystem, `rENM.core`: - Defines the canonical **project directory structure** - Provides consistent access to **species metadata and variables** - Standardizes **path resolution** across all downstream packages - Ensures **reproducible, CRAN-compliant workflows** (no hard-coded paths)
